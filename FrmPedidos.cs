...
namespace Garmoxu_Project
{
    public partial class FrmPedidos : Form
    {
        ...
        private void BtnPedidoEnCurso_Click(object sender, EventArgs e)
        {
            ...
            FrmDetallesPedido frm = new FrmDetallesPedido(ConexionBD, clavePrimaria, Instance, UsuarioActual);
            frm.Show();
        }
        ...
        private bool ValidarDatoExistente(String filtro)
        {
            ...
            if (cmd.ExecuteScalar() != null)
            {
                FrmDetallesPedido frm = new FrmDetallesPedido(ConexionBD, cmd.ExecuteScalar().ToString(), Instance, UsuarioActual);
                frm.Show();
        ...
        {
            NuevoPedido(new FrmDetallesPedido(ConexionBD, "", Instance, UsuarioActual));
        }
