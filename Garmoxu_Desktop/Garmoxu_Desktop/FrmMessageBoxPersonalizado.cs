...
namespace Garmoxu_Desktop
{
    public partial class FrmMessageBoxPersonalizado : Form
    {
        ...
        public static DialogResult ShowMePassword(string usuarioActual, MySqlConnection conexionBD)
        {
            ...
            frm.SetConfigButtons(FrmMessageBoxPersonalizado.ButtonYesCancel());
        ...
        private bool AceptarPassword()
        {
            if (!string.IsNullOrEmpty(UsuarioActual))
            {
                    ...
                    && ValidarFormatoContraseñas() && ValidarContraseñaActual())
                {
                    ...
                    FrmMessageBoxPersonalizado.ShowMe(mensaje, "", FrmMessageBoxPersonalizado.ButtonYes(), FrmMessageBoxPersonalizado.IconInfo());
                    UsuarioActual = user;
                    return true;
                }
                else return false;
        ...
        private bool ValidarDatosCompletados()
        {
            ...
            FrmMessageBoxPersonalizado.ShowMe(mensaje, "", FrmMessageBoxPersonalizado.ButtonYes(), FrmMessageBoxPersonalizado.IconWarning());
            UsuarioActual = user;
            return false;
        }
