...
namespace Garmoxu_Project
{
    public partial class FrmReservas : Form
    {
        ...
        private void BtnNuevo_Click(object sender, EventArgs e)
        {
            ...
            FrmDetallesReserva f = new FrmDetallesReserva(ConexionBD, string.Empty, Instance);
        ...
        private void DtgReservas_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (ValidarReservaDisponible())
            {
                ...
                FrmDetallesReserva f = new FrmDetallesReserva(ConexionBD, clavePrimaria, Instance);
                f.Width = (Instance.Width / 3);
                f.Height = (Instance.Height / 2) + (Instance.Height / 4);
