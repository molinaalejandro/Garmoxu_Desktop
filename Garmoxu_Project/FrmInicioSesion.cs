...
namespace Garmoxu_Project
{
    public partial class FrmInicioSesion : Form
    {
        ...
        private void BtnPassword_Click(object sender, EventArgs e)
        {
            ...
            else if (!TbxPassword.Text.Equals("Contraseña"))
            {
        ...
        private void IniciarSesion()
        {
            ...
            {
                MessageBox.Show("¡El usuario y contraseña introducidos no son correctos!", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void CrearNuevaContraseña()
        {
            ...
            {
                if (FrmMessageBox.ShowMePassword(TbxUser.Text, ConexionBD).Equals(DialogResult.Yes))
                {
