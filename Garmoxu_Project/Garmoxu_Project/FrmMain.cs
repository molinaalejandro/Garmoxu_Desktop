...
namespace Garmoxu_Project
{
    public partial class FrmMain : Form
    {
        ...
        public FrmMain(MySqlConnection conexionBD)
        {
            InitializeComponent();
            instance = this;
        ...
        {
            AbrirFormulario(new FrmPedidos(ConexionBD, instance));
        }

        private void BtnReservas_Click(object sender, EventArgs e)
        {
            AbrirFormulario(new FrmReservas(ConexionBD));
        }

        private void BtnHistorialPedidos_Click(object sender, EventArgs e)
        {
            AbrirFormulario(new FrmHistorialPedidos());
        }
