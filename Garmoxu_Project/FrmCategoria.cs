...
namespace Garmoxu_Project
{
    public partial class FrmCategoria : Form
    {
        ...
        public FrmCategoria(MySqlConnection conexionBD, FrmMain instance)
        {
            InitializeComponent();
        ...
        {
            FrmCategoriaDetalles frm = new FrmCategoriaDetalles(ConexionBD, string.Empty, Instance);
            frm.Width = 316;
            frm.Height = 434;
        ...
        private void LstCategorias_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            FrmCategoriaDetalles frm = new FrmCategoriaDetalles(ConexionBD, clavePrimaria, Instance);
            frm.Width = 316;
            frm.Height = 434;
            BtnEliminar.Enabled = false;
            Instance.Enabled = false;
