...
namespace Garmoxu_Project
{
    public partial class FrmUsuarios : Form
    {
        ...
        {
            FrmUsuarioNuevo f = new FrmUsuarioNuevo(ConexionBD, Instance);
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Ds.Tables["Usuarios"].DefaultView.RowFilter = "NombreUsuario LIKE '%" + busqueda + "%'";
                DtgUsuarios.DataSource = Ds.Tables["Usuarios"];
            }
        }
        ...
        private void CargarImagen(MySqlDataReader lector)
        {
            if (!string.IsNullOrEmpty(lector[4].ToString()))
            {
                ...
                PicUsuario.Image = Properties.Resources.noImage;
        }
        #endregion
        ...
        {
            if (TxtBuscar.Texts.Trim().Equals("Nombre de usuario"))
            {
        ...
        private void TxtBuscar_Leave(object sender, EventArgs e)
        {
            ...
            {
                TxtBuscar.Texts = "Nombre de usuario";
        ...
        private void DtgUsuarios_EnabledChanged(object sender, EventArgs e)
        {
            if (Enabled)
                CargarDatos();
        }
